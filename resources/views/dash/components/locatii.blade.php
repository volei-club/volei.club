                ...
                <div class="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-700 rounded-2xl p-5 shadow-sm space-y-3">
                    ...
                    <template x-if="user?.role === 'administrator'">
                        <div class="flex items-center gap-2">
                             ...
                             <span class="px-2 py-1 bg-slate-100/50 dark:bg-slate-800/50 text-slate-600 dark:text-slate-400 border border-slate-200/50 dark:border-slate-700/50 rounded-lg text-[11px] font-bold uppercase tracking-wide" x-text="loc.club?.name || 'N/A'"></span>
                        </div>
                    </template>
